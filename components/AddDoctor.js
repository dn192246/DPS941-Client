...
import { StyleSheet, View, Alert, Text, TextInput, TouchableOpacity, SafeAreaView, Image, ScrollView, ActivityIndicator } from 'react-native';
    ...
    const handleSubmit = async () => {
        ...
        if (nombre && telefono && email && especialidad) {
            ...
            try {
                ...
                setIsLoading(false);
                Alert.alert("Éxito", "Se ha almacenado correctamente el doctor");
